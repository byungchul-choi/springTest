...
import tpost.SimpleTest.controller.SimpleTest;
...
public class TimeClientHandler extends SimpleChannelInboundHandler<Object> {
	...
	public void channelRead0(ChannelHandlerContext ctx, Object msg) {
	    ...
	    String readMessage = ((ByteBuf)msg).toString(utf8);
	    
	    //4.서버로 부터 수신된 데이터가 저장된 msg 객체에서 문자열 데이터 추출
	    SimpleTest cc = new SimpleTest();
	    try {
			cc.retMsg(msg);
...
//	    ctx.close();
	...
	public void setSendMsg(ByteBuf byteBuf) {
