...
function sttcInfoListSelect(){
	...
	acmdCerfListForm.action = "sttcBfrInfo";
                	...
                	<table class="vtable">
						...
						<tbody id="detlTopTable">
							<tr>
								...
								<td class="text-r">${resultList.allCsntCnt}</td>
								<td class="text-r">${resultList.allRfslCnt}</td>
								<td class="text-r">${resultList.allCsntRate}</td>
	                        </tr>
						</tbody>
                    </table>
                    <!-- //table -->
...
<!--                                 <th scope="col" rowspan="2" >템플릿명</th> -->
                                ...
                                <th scope="col" colspan="3">동의/거부건수</th>
                            </tr>
                            <tr>
                                <th scope="col">성공</th>
                                <th scope="col">실패</th>
...
<%-- 									<td>${resultListDetail.tmpltCd}</td> --%>
									...
									<td>${resultListDetail.csntCnt}</td>
									<td>${resultListDetail.rfslCnt}</td>
									<td>${resultListDetail.csntRate}</td>
								</tr>
							</c:forEach>
                        </tbody>
                    </table>
